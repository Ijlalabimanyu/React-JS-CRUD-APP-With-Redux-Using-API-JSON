    ...
    <div>
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-lg">
        ...
        <div className="border-t border-gray-200">
          <dl>
            {[
              { label: 'Nama', value: userDetail.nama },
              { label: 'NIM', value: userDetail.nim },
              { label: 'Jurusan', value: userDetail.jurusan },
              { label: 'Email', value: userDetail.email },
              { label: 'Telepon', value: userDetail.telepon },
            ].map(({ label, value }) => (
              <div className="even:bg-gray-50 odd:bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
